...
expert = RealtorLevel.create(
    ...
    free_content: "https://corefact-marketing.s3.us-west-1.amazonaws.com/academy-pdf/Brand_Marketing_Guide_Quarter4.pdf",
